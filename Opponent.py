from images import opponent_1_left_image, opponent_1_right_image, opponent_1_down_image
...
class Opponent(GameObject):
    """
    Super class of the game objects: OpponentOne and OpponentTwo.
    Opponent class inherits from class Game Object.
    ...
    def __init__(self):
        ...
        self.img_dict = {'UP': opponent_1_down_image,
